...
class Trainer:
    ...
    def export_to_csv(self,csvPath):
        ...
        data = {}
        for field in fields:
            if field in self.config['model']['backbone']['params']:
                data[field] = self.config['model']['backbone']['params'][field]
            elif field in self.config['model']['params']:
                data[field] = self.config['model']['params'][field]
